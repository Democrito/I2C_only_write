...
* La señal **start** siempre antecederá el paquete de dirección.
* La señal **stop**  siempre estará al final del paquete de dato(s). El paquete de datos puede ser uno o muchos, no importa. Esta señal ha de ocurrir al finalizar el envío de un paquete de información.
...
La gran mayoría de las veces los periféricos (esclavos I2C) el número de "bytes" a enviar son fijos, pero existen periféricos que ese tamaño podría ser variable, porque antes de ponerlo en marcha necesita cierta configuración, y eso es lo que sucede si queremos manejar una pantalla OLED (por ejemplo).
...
Dejo una imagen de las señales que da [**Pulse View**](https://sigrok.org/wiki/Downloads). Gracias a ese programa podemos verificar cualquier tipo de señal. Si no tiene un analizador lógico, puedes usar el módulo [**ICROK**](https://github.com/FPGAwars/iceRok) que se encuentra dentro de Icestudio.
